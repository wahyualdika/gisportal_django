	...
	var map, layeradm, layerp2k=[], layerpendik=[];
	var a = [];
		a[0] = "http://123.108.97.62:6080/arcgis/rest/services/webgispdga/05_Tutupan_Lahan_Aceh_1990/MapServer/3"; // layer tutupan lahan 1990
		a[1] = "http://123.108.97.62:6080/arcgis/rest/services/webgispdga/05_Peta_Tutupan_Lahan_Aceh_2000/MapServer/4"; //layer tutupan lahan 2000
		a[2] = "http://123.108.97.62:6080/arcgis/rest/services/webgispdga/05_Tutupan_Lahan_Aceh_2006/MapServer/4"; // layer tutupan lahan 2006
		a[3] = "http://123.108.97.62:6080/arcgis/rest/services/webgispdga/05_Tutupan_Lahan_Aceh_2013/MapServer/4"; // layer tutupan lahan 2013
		a[4] = "http://123.108.97.62:6080/arcgis/rest/services/webgispdga/05_Tutupan_Lahan_Aceh_2013/MapServer/3"; // layer pola ruang
		a[5] = "http://123.108.97.62:6080/arcgis/rest/services/Struktur/Pelabuhan_Provinsi_Aceh/MapServer/0"; // layer pelabuhan
		a[6] = "http://123.108.97.62:6080/arcgis/rest/services/Transportasi/Bandara_Provinsi_Aceh/MapServer/0"; // layer bandara
		a[7] = "http://123.108.97.62:6080/arcgis/rest/services/Transportasi/Terminal_Provinsi_Aceh/MapServer/0"; // layer terminal
		a[8] = "http://123.108.97.62:6080/arcgis/rest/services/Struktur/Kawasan_Wisata_Provinsi_Aceh/MapServer/0"; // layer kawasan wisata
		a[9] = "http://123.108.97.62:6080/arcgis/rest/services/Kesehatan/Kesehatan_Provinsi_Aceh/MapServer/0"; // layer kesehatan
		a[10] = "http://123.108.97.62:6080/arcgis/rest/services/webgispdga/Sarana_Perhubungan_Aceh/MapServer/0"; // layer perhubungan
		// a[11] = "http://gis.pidiejayakab.go.id:8399/arcgis/rest/services/pjpetadasar/MapServer/69"; // layer kemiskinan pidie jaya
		a[12] = "http://123.108.97.62:6080/arcgis/rest/services/webgispdga/BadanDayah_Aceh_All_v10/MapServer/0"; // layer dayah
		a[13] = "http://gisportal.acehprov.go.id:6080/arcgis/rest/services/DKP_ACEH/BatasWilayahLaut_AR_Aceh/MapServer/0"; // layer batas laut
		a[14] = "http://gisportal.acehprov.go.id:6080/arcgis/rest/services/DKP_ACEH/WilayahPengelolaanPerikanan_AR/MapServer/0"; // layer batas ikan
		a[15] = "http://gisportal.acehprov.go.id:6080/arcgis/rest/services/DKP_ACEH/WilayahPengelolaanPerikanan_AR/MapServer/1"; // layer batas ikan 2
		a[16] = "http://gisportal.acehprov.go.id:6080/arcgis/rest/services/DAS/Peta_Tingkat_Kerawanan_Banjir_DAS_Tamiang/MapServer/0"; // layer rawan banjir tamiang
		a[17] = "http://gisportal.acehprov.go.id:6080/arcgis/rest/services/DAS/Peta_Tingkat_Kerawanan_DAS_Teunom/MapServer/0"; // layer rawan banjir teunom
		//a[18] = "http://123.108.97.62:6080/arcgis/rest/services/webgispdga/Monev2017/MapServer/0"; // layer monev2017
	...
	//		  [11]= data kemiskinan pijay (tidak terpakai), [12]= dayah, [13]= batas laut, [14]= batas ikan, [15]= batas ikan 2, [16]= rawan banjit tamiang
	//		  [17]= rawan banjir teunom.
	...
	function init() {
		...
		layeradm = new esri.layers.ArcGISDynamicMapServiceLayer("http://123.108.97.62:6080/arcgis/rest/services/webgispdga/Aceh_Adm_shp_v10/MapServer",{
			"imageParameters":adm
		});
		...
		var konteninfrakesehatan = "<table><tr><td width=100> <b>Nama</b> </td><td> ${nama} </td></tr>" +
				   "<tr><td width=100> <b>Lokasi</b> </td><td> ${alamat} </td></tr>" +
				   "<tr><td width=100> <b>Kabupaten</b> </td><td> ${nm_kab} </td></tr>" +
				   "<tr><td width=100> <b>Keterangan</b> </td><td> ${keterangan} </td></tr>" +
		...
		var kontenmonev2017 = "<table><tr><td width=100> <b>Sektor</b> </td><td> ${SEKTOR} </td></tr>" +
						"<tr><td width=100> <b>SKPA/SKPD</b> </td><td> ${SKPA_SKPD} </td></tr>" +
						"<tr><td width=100> <b>Paket</b> </td><td> ${NAMA_PAKET} </td></tr>" +
						"<tr><td width=100> <b>Pagu</b> </td><td> Rp. ${PAGU} </td></tr>" +
						"<tr><td width=100> <b>Lokasi</b> </td><td> ${KABUPATEN} </td></tr>" +
						"<tr><td width=100> <b>Kecamatan</b> </td><td> ${KECAMATAN} </td></tr>" +
						"<tr><td width=100> <b>Desa</b> </td><td> ${DESA} </td></tr></table>" +
		...
		findTask[0] = new esri.tasks.FindTask("http://123.108.97.62:6080/arcgis/rest/services/webgispdga/KegiatanP2K_2013_all_v10/MapServer"); // p2k
		findTask[1] = new esri.tasks.FindTask("http://123.108.97.62:6080/arcgis/rest/services/webgispdga/Sarana_Perhubungan_Aceh/MapServer"); // perhubungan
		findTask[2] = new esri.tasks.FindTask("http://123.108.97.62:6080/arcgis/rest/services/Pendidikan/Pendidikan_Aceh/MapServer"); // pendidikan
		...
		layerpendik[0] = new esri.layers.FeatureLayer("http://123.108.97.62:6080/arcgis/rest/services/Pendidikan/Pendidikan_Aceh/MapServer/0",{
			mode: esri.layers.FeatureLayer.MODE_ONDEMAND,
			outFields: ["*"],
			infoTemplate: popup[5]
		});
		layerpendik[0].setDefinitionExpression("nm_sekolah LIKE 'SMA%' OR nm_sekolah LIKE 'SMK%' OR nm_sekolah LIKE 'MAN%'"); 
		
		// layer pendidikan SMP sederajat
		layerpendik[1] = new esri.layers.FeatureLayer("http://123.108.97.62:6080/arcgis/rest/services/Pendidikan/Pendidikan_Aceh/MapServer/0",{
			mode: esri.layers.FeatureLayer.MODE_ONDEMAND,
			outFields: ["*"],
			infoTemplate: popup[5]
		});
		layerpendik[1].setDefinitionExpression("nm_sekolah LIKE 'SMP%' OR nm_sekolah LIKE 'MTSN%' OR nm_sekolah LIKE 'MTSS%'");
		
		// layer pendidikan SD sederajat
		layerpendik[2] = new esri.layers.FeatureLayer("http://123.108.97.62:6080/arcgis/rest/services/Pendidikan/Pendidikan_Aceh/MapServer/0",{
			mode: esri.layers.FeatureLayer.MODE_ONDEMAND,
			outFields: ["*"],
			infoTemplate: popup[5]
		});
		layerpendik[2].setDefinitionExpression("nm_sekolah LIKE 'SD%' OR nm_sekolah LIKE 'MIN%'");
	...
	function getp2k(id, sektor){
		var expr;
		if (layerp2k[id] == null){
			layerp2k[id] = new esri.layers.FeatureLayer("http://123.108.97.62:6080/arcgis/rest/services/webgispdga/KegiatanP2K_2013_all_v10/MapServer/0", {
				mode: esri.layers.FeatureLayer.MODE_ONDEMAND,
				outFields: ["*"],
	...
	function getmonev2017(id, sektor){
		var expr;
